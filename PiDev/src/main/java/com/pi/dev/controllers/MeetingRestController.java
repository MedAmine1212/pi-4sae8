...
public class MeetingRestController {
	...
	@PutMapping("/setContributor/{idMeeting}/{idContributor}")
	public void setContributor(@PathVariable Long idMeeting,@PathVariable Long idContributor){
		ms.setContributor(idMeeting, idContributor);	
	}
